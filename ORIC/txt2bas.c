// txt2bas.c - convert a file to basic
//
// it's not sure what copyright matters
// for this file, it's unmentioned in:
//   https://osdk.org/index.php?page=documentation&subpage=copyright
